...
GitHub Copilot instructions and development guardrails enforced
across all projects.
...
Centralized AI coding instructions that define how Copilot
behaves across repositories. Enforces architecture patterns,
test standards, and security policies at the IDE level.
